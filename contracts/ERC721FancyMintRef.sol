    ...
    IERC2309
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721FancyMint.ownerOf(tokenId);
     ...
     *
     * Tokens start existing when they are minted (`via constructor`),
    ...
    function _transfer(
        ...
        require(
            ERC721FancyMint.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721FancyMint.ownerOf(tokenId), to, tokenId);
    }
